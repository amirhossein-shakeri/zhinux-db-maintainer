...
func NewBackupArtifactRepository(
	pool *pgxpool.Pool,
) outbound_ports.BackupArtifactRepository {
	return &backupArtifactRepositoryImpl{pool: pool}
}

func (r *backupArtifactRepositoryImpl) Save(
	ctx context.Context, artifact *backup.BackupArtifact,
) error {
	if artifact == nil {
...
func (r *backupArtifactRepositoryImpl) FindByID(
...
func (r *backupArtifactRepositoryImpl) ListByDatabaseID(
	ctx context.Context, databaseID string,
) ([]*backup.BackupArtifact, error) {
	rows, err := r.pool.Query(ctx,
		backupArtifactListByDatabaseIDSQL, databaseID)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
...
func (r *backupArtifactRepositoryImpl) SoftDelete(
	ctx context.Context, id string,
) error {
...
INSERT INTO backup_artifacts (
	id, database_id, backup_job_id, storage_location, size_bytes, checksum, created_at, deleted_at, updated_at
) VALUES (
	$1, $2, $3, $4, $5, $6, $7, $8, $9
